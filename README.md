...
3. Scripts externos Asincronos
   Tanto con async como defer podemos hacer llamados asíncronos pero tiene sus diferencias: - **async:** Con async podemos hacer la petición de forma asíncrona y no vamos a detener la carga del DOM hasta que se haga la ejecución del código.
   ![Script embebido](./screenshots/async.png)
   ![Script embebido](./screenshots/ordenDeEjecuciónAsync.png) - **defer:** La petición es igual asíncrona como en el async pero va a deferir la ejecución del Javascript hasta el final de que se cargue todo el documento.
...
- El objeto [Proxy](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Proxy) se usa para definir un comportamiento personalizado para operaciones fundamentales (por ejemplo, para observar propiedades, cuando se asignan, enumeración, invocación de funciones, etc).
...
- [Patrones de Diseño de CSS](https://every-layout.dev)
- [Patrones de Diseño de Media Queries - Responsive Design](https://mediaqueri.es)

### ¿Qué es un patron de diseño?

Un patron de diseño es una solución a un problema dentro de un contexto que se repite.
El contexto es la situación donde el patron aplica.

### Categorías de patrones de diseño

- [patrones de diseño con ayudas visuales](https://refactoring.guru/es/design-patterns)

1. **Creacionales:** Proveen diferentes mecanismos para crear objetos.
   - **Abstract Factory**
   - **Builder o Constructor** es un patron que permite crear varios objetos complejos paetiendo de un Objeto fuente/raiz/Madre/Padre
   - **Factory Method**
   - **Prototype**
   - **Singleton**
2. **Estructurales:** Describen formas de componer objetos para formar nuevas estructuras flexibles y eficientes.
   - **Adapter**
   - **Bridge**
   - **Composite**
   - **Decorator**
   ...
   - **Flyweight**
   - **Proxy**
3. **Comportamiento:** Gestionan algoritmos y responsabilidades entre objetos.
